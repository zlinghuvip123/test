...
class HttpRunner(object):
    ...
    def _add_tests(self, testcases):
        """ initialize testcase with Runner() and add to test vsuite.
    ...
    def run_tests(self, tests_mapping):
        ...
        parsed_testcases, parse_failed_testcases = parser.parse_tests(tests_mapping)
        ...
        self._summary = self._aggregate(results, parse_failed_testcases)
