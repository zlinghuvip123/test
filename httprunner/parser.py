        ...
        if "parameters" in testcase and testcase["parameters"]:
            ...
            for parameter_variables in cartesian_product_parameters:
                ...
                try:
                    ...
                    pass
                    #parse_failed_testcase_list.append(parsed_failed_testcase)
            ...
            try:
                ...
                parse_failed_testcase_list.append(testcase_name)

    return parsed_testcase_list, parse_failed_testcase_list
...
def _parse_testsuite(testsuite, project_mapping):
    ...
    parsed_testcase_list, parse_failed_testcase_list = __get_parsed_testsuite_testcases(
        testsuite["testcases"],
        prepared_config,
        project_mapping
    )
...
def parse_tests(tests_mapping):
    ...
    for test_type in tests_mapping:
        ...
        if test_type == "testsuites":
            ...
            for testsuite in testsuites:
                parsed_testcases, failed_testcases = _parse_testsuite(testsuite, project_mapping)
                for parsed_testcase in parsed_testcases:
                    testcases.append(parsed_testcase)
                parse_failed_testcases.extend(failed_testcases)
    ...
    return testcases, parse_failed_testcases
