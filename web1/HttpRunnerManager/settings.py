...
if DEBUG:
    DATABASES = {
        'default': {
            ...
            'USER': 'root',  # 数据库登录名
            'PASSWORD': '123@QWE.com',  # 数据库登录密码
            'HOST': '10.6.209.209',  # 数据库所在服务器ip地址
...
BROKER_URL = 'amqp://guest:guest@10.3.12.245:15672//' if DEBUG else 'amqp://dev:zwc123@192.168.91.45:5672//'
...
EMAIL_SEND_USERNAME = 'linghu.zeng@united-imaging.com'  # 定时任务报告发送邮箱，支持163,qq,sina,企业qq邮箱等，注意需要开通smtp服务
EMAIL_SEND_PASSWORD=''
